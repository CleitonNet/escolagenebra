<div class="my-28">
    <x-guest.container id="section_why">
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            ...
            <div data-aos="fade-up"   data-aos-duration="1500" class="pt-0 -mt-14 pb-14 sm:pt-0 sm:pb-14 sm:-mt-14 md:mt-0 md:pt-0 md:pb-14 lg:pt-0 lg:pb-14 xl:pt-0 xl:pb-14"         ><x-guest.why-item :image="asset('img/programa-trilíngue.webp')" :link="route('guest.trilingual_program')"         :text="'Programa Trilíngue'"          /></div>
