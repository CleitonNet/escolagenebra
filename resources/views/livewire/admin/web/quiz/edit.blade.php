...
<form wire:submit="save" enctype="multipart/form-data">
    ...
    <div class="flex justify-center gap-2">
        ...
        <label for="quizImage" class="relative flex items-center justify-center flex-auto mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-[528px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
            ...
            @endif
            <input wire:model.blur='getImageCover' type="file" name="quizImage" id="quizImage" class="absolute opacity-0 -z-10" accept="image/*" />
    ...
    <label class="p-2 bg-white cursor-pointer rounded-lg mb-4 w-full block">
        <input wire:model.blur="getSong" type="file" name="audio" id="audio" accept=".mp3">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
        ...
        <input wire:model.blur='name' class="col-span-full px-4 py-3 border rounded-lg shadow bg-white/90" type="text"
            placeholder="name" name="name" id="name" />

        <textarea wire:model.blur='description' class="col-span-full px-4 py-3 border rounded-lg shadow bg-white/90 mb-4" rows="5" name="description" id="description" placeholder="Description"></textarea>
        ...
        <label for="quizResult1" class="relative flex items-center justify-center flex-auto mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-[300px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
            @if ($getImageResult1)
                <img src="{{ $getImageResult1->temporaryUrl() }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5));" />
            @elseif ($result1 !== null && Storage::disk('public')->exists($quiz->result1))
                <img src="{{ asset('storage/' . $result1) }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000" />
            @else
                <img src="{{ asset('img/upload.svg') }}" alt="image" class="absolute object-cover w-40 h-40 opacity-50 group-hover:opacity-75" style="filter: drop-shadow(0 0 2px rgba(0,0,0,.5))" />
            @endif
            <input wire:model.blur='getImageResult1' type="file" name="quizResult1" id="quizResult1" class="absolute opacity-0 -z-10" accept="image/*" />
        ...
        <label for="quizResult2" class="relative flex items-center justify-center flex-auto mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-[300px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
            @if ($getImageResult2)
                <img src="{{ $getImageResult2->temporaryUrl() }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5));" />
            @elseif ($result2 !== null && Storage::disk('public')->exists($quiz->result2))
                <img src="{{ asset('storage/' . $result2) }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000" />
            @else
                <img src="{{ asset('img/upload.svg') }}" alt="image" class="absolute object-cover w-40 h-40 opacity-50 group-hover:opacity-75" style="filter: drop-shadow(0 0 2px rgba(0,0,0,.5))" />
            @endif
            <input wire:model.blur='getImageResult2' type="file" name="quizResult2" id="quizResult2" class="absolute opacity-0 -z-10" accept="image/*" />
        ...
        <label for="quizResult3" class="relative flex items-center justify-center flex-auto mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-[300px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
            @if ($getImageResult3)
                <img src="{{ $getImageResult3->temporaryUrl() }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5));" />
            @elseif ($result3 !== null && Storage::disk('public')->exists($quiz->result3))
                <img src="{{ asset('storage/' . $result3) }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000" />
            @else
                <img src="{{ asset('img/upload.svg') }}" alt="image" class="absolute object-cover w-40 h-40 opacity-50 group-hover:opacity-75" style="filter: drop-shadow(0 0 2px rgba(0,0,0,.5))" />
            @endif
            <input wire:model.blur='getImageResult3' type="file" name="quizResult3" id="quizResult3" class="absolute opacity-0 -z-10" accept="image/*" />
        ...
        <label for="quizResult4" class="relative flex items-center justify-center flex-auto mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-[300px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
            @if ($getImageResult4)
                <img src="{{ $getImageResult4->temporaryUrl() }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5));" />
            @elseif ($result4 !== null && Storage::disk('public')->exists($quiz->result4))
                <img src="{{ asset('storage/' . $result4) }}" alt="image" class="object-cover min-w-full min-h-full border border-slate-300" style="box-shadow: 0 0 10px 2px #000" />
            @else
                <img src="{{ asset('img/upload.svg') }}" alt="image" class="absolute object-cover w-40 h-40 opacity-50 group-hover:opacity-75" style="filter: drop-shadow(0 0 2px rgba(0,0,0,.5))" />
            @endif
            <input wire:model.blur='getImageResult4' type="file" name="quizResult4" id="quizResult4" class="absolute opacity-0 -z-10" accept="image/*" />
