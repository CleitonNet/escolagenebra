...
<div class="content mb-20">
    <form wire:submit="save" enctype="multipart/form-data">
        ...
        {{-- <div class="flex gap-4 flex-col items-center lg:flex-row">
            <label for="slideImage" class="relative flex items-center justify-center aspect-video min-w-96 w-full mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group max-h-[528px] bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
                @if ($getImage)
            ...
            <label for="slideVerticalImage" class="relative flex items-center justify-center min-w-72 w-1/4 mb-4 overflow-hidden border-4 border-white rounded-lg shadow cursor-pointer group h-96 bg-slate-300/75 group-hover:bg-slate-300" style="box-shadow: inset 0 0 10px 2px rgba(0,0,0,0.7);">
                ...
                @elseif ($verticalImage !== null && Storage::exists('public/' . $slide->verticalImage))
