<x-guest.segmentos.segmentos>
    ...
    <div class="swiper segments px-2 sm:px-4">
        ...
        <div class="swiper-wrapper">
            ...
            <x-guest.segmentos.segmento duration='1250' stitle='Ens. <span class="text-nowrap">Fundamental I</span>' :gotoURL="route('guest.segments.fundamentalI')"
                image='img/segmento-fundamental-i.webp'
            ...
            <x-guest.segmentos.segmento duration='1500' stitle='Ens. <span class="text-nowrap">Fundamental II</span>' :gotoURL="route('guest.segments.fundamentalII')"
                image='img/segmento-fundamental-ii.webp'
            ...
            <x-guest.segmentos.segmento target="_blank" duration='1750' stitle='Ens. Médio' :gotoURL="route('guest.segments.high-school')"
