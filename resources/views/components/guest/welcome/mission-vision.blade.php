<div class="relative">
    <img src="{{ asset('img/Ellipse-left.webp') }}" class="absolute left-0 top-40 opacity-5 lg2:opacity-80 h-2/3" alt="...">
    <img src="{{ asset('img/Ellipse-right.webp') }}" class="absolute right-0 -top-20 opacity-5 lg2:opacity-80 h-2/3 -z-10" alt="...">

    <div class="text-center font-poppins text-azul2 grid gap-14 max-w-5xl mx-auto mt-20 px-4 lg:px-8">
        <div>
            <div class="flex gap-2 py-1 items-center font-bold text-4xl justify-center border-2 border-azul2 rounded-lg relative">
                <div class="flex gap-1 absolute left-4 -z-10">
                    <div class="h-3 w-3 bg-vermelho rounded-full"></div>
