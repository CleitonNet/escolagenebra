<div class="items-stretch justify-center hidden xl:gap-x-6 lg:gap-x-2.5 sm:-my-px lg:flex">
    <x-guest.nav-link aria-label="Sobre a escola" :href="route('guest.about')" :active="request()->routeIs('guest.about')">{{ __('Quem somos') }}</x-guest.nav-link>
    <x-guest.dropdown-wide :active="(request()->routeIs('guest.segments.*'))" trigger='Segmentos'>
        <x-slot name='content'>
            <x-guest.container class="grid grid-cols-4 gap-4 px-4 lg:px-4">
                ...
                <a aria-label="Garderie/ Educação Infantil" href="{{ route('guest.segments.garderie') }}" class="p-2.5 bg-azul/10 hover:bg-azul transition-all duration-200 group">
                ...
                <a aria-label="Ensino Fundamental 1" href="{{ route('guest.segments.fundamentalI') }}" class="p-2.5 bg-azul/10 hover:bg-azul transition-all duration-200 group">
                ...
                <a aria-label="Ensino Fundamental 2" href="{{ route('guest.segments.fundamentalII') }}" class="p-2.5 bg-azul/10 hover:bg-azul transition-all duration-200 group">
                ...
                <a aria-label="Ensino Médio" href="{{ route('guest.segments.high-school') }}" target="_blank" class="p-2.5 bg-azul/10 hover:bg-azul transition-all duration-200 group">
    ...
    <x-guest.nav-link aria-label="Galeria de Fotos" :href="'https://galeriagenebra.myportfolio.com/work'" target="_blank">{{ __('Galeria') }}</x-guest.nav-link>
    <x-guest.nav-link aria-label="Matrícula" :href="route('guest.enrollment')" :active="request()->routeIs('guest.enrollment')">{{ __('Matrícula') }}</x-guest.nav-link>
</div>
