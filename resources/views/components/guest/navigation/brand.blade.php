<div class="flex items-center gap-1.5 md:gap-2">
    <!-- Logo -->
    <a href="{{ route('guest.welcome') }}" class="flex items-center sm:gap-0.5">
    ...
    <a href="https://ib.escolagenebra.com.br" target="_blank" class="flex items-center xs:gap-0.5 sm:gap-1 pt-2">
